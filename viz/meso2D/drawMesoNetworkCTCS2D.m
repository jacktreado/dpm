...
% create file name
% fstr = 'local/mesoHMin2D_data/mesoHMin2D_N64_n32_ca1.14_kb01e-3_be125_da1e-3_dl1.1_P1e-3_h0.5_cL1_cB1_seed15.ctcpos';
...
if NFRAMES > 2
    ...
    errorbar(1-phi,mean(calA0,2),std(calA0,0,2),'ko','markersize',10);
